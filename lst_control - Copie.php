...
.form-control:-ms-input-placeholder{color:#c0c5ca;opacity:1}.form-control::-ms-input-placeholder{color:#c0c5ca;opacity:1}.form-control::placeholder{color:#c0c5ca;opacity:1}

.form-control::-webkit-input-placeholder{color:#c0c5ca;opacity:1}
                ...
                <!-- ============================================================== -->				
				 <div class="row">
				  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
					...
					<a href="<?php echo $page_c;?>" class="breadcrumbs_home"><i class='fas fa-handshake nav_icon'></i>  <?php echo $mnu_title; ?></a> <span class="raquo">»</span></div>
                        </div>
                    </div>
                </div>
								...
								<div class="card mb-1">
											...
											<div class="card-body">
												<div class="row">
													...
													<div class="col">
														<div class="row mb-2">
															<div class="col-sm-12 text-right pr-1"> <div class="text-right">
  ...
  <select class="custom-select ml-auto w-auto" id="show" onChange="changeDisplayRowCount(this.value);">
							...
							$stmt_chief = null;
                                        ...
                                        while ($row_chief = $stmt_chief->fetch(PDO::FETCH_ASSOC)) {
                                            echo "<option value=t_log_controle.controleur='" .$row_chief["code_utilisateur"].  "'>Contrôleur - " . $row_chief["nom_complet"] ; "</option>";
                                        }
                               ...
                               $stmt_select = $commune->GetProvinceAllCommune($USER_SITE_PROVINCE);
                                ...
                                $stmt_select = $commune->GetProvinceAllCVS($USER_SITE_PROVINCE);
                                        while ($row_select = $stmt_select->fetch(PDO::FETCH_ASSOC)) {
                          ...
                          <div class="card">
							<div class="card-body">
								...
								<div class="form-group">
                                    ...
                                    <div class="input-group"  style="width: 100%;" > 
                                        <input type="text" class="form-control pull-right allow-numeric" name="numero_serie_cpteur" id="numero_serie_cpteur" required>
                                    </div>                
                                </div>
								<div class="form-group">
...
<?php } 
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">SCELLES EXISTANTS</h5>
								<div class="card-body">
								<div class="form-group">
                                    <label>SCELLE 1</label>
                                    <div class="input-group"  style="width: 100%;" > 
                                        <input type="text" class="form-control pull-right" name="scelle_cpt_existant" id="scelle_cpt_existant">
                                    </div>                
                                </div>
								<div class="form-group">
                                    <label>SCELLE 2</label>
                                    <div class="input-group"  style="width: 100%;" > 
                                        <input type="text" class="form-control pull-right" name="scelle_coffret_existant" id="scelle_coffret_existant">
                                    </div>                
                                </div>
								</div>
                            </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">SCELLES POSES PAR LE CONTROLLEUR</h5>
								<div class="card-body">
								<div class="form-group">
                                    <label>SCELLE COFFRET</label>
                                    <div class="input-group"  style="width: 100%;" > 
                                        <input type="text" class="form-control pull-right" name="scelle_compteur_poser" id="scelle_compteur_poser">
                                    </div>                
                                </div>
								<div class="form-group">
                                    <label>SCELLE COMPTEUR</label>
                                    <div class="input-group"  style="width: 100%;" > 
                                        <input type="text" class="form-control pull-right" name="scelle_coffret_poser" id="scelle_coffret_poser">
                                    </div>                
                                </div>
								</div>
                            </div>
                            ...
                            <div class="card">
								...
								<div id="bloc_info_fraude">
									...
									<div class="form-group">
										...
										<div class="input-group"  style="width: 100%;" > 
											<select class='form-control select2' style='width: 100%;' name='type_fraude'  id='type_fraude' >
											<option selected='selected' disabled>Veuillez préciser</option>
											<?php
...
<?php } 
                       ...
                       <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                             <div class="form-group">
                                    ...
                                    <div class="input-group"  style="width: 100%;" > 
                                        <textarea class="form-control pull-right" name="observation" id="observation" required ></textarea>
                                    </div>                
                                </div>
                        </div>
                       <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
...
<input id="bloc_destination"  type="hidden">	  
			<div id="my_camera_control" style="width: 320px; height: 240px;"><div></div><video id="webcam_control"  autoplay="autoplay" style="width: 320px; height: 240px;"></video>
 ...
 var ctr =0;
   ...
   $('form input').keydown(function(e){
    ...
    /* $('#mainForm_control .select2').each(function(){
		...
		$('#filtre').select2({ placeholder: "Filtre", multiple: true});	
		...
		if($('#accessibility_client').val() == 4){
		    ...
		    $.ajax({
                                ...
                                url:"controller.php",
                                        ...
                                        error:function(err){
                                console.error(err);$("#btn_submit_refus").removeAttr('disabled');
...
/*	jQuery(document).delegate('a.delete-control-item', 'click', function(e) {
		e.preventDefault(); 
		var itemId = $(this).parents('tr.item-row-control').attr('item-id');
		var label=$('tr.item-row-control[item-id="' + itemId + '"]').find('span.sn').html();     
		swal({
			title: "Information",
			...
			closeOnCancel: true
								...
								if (isConfirm) {
									$('tr.item-row-control[item-id="' + itemId + '"]').remove();
									reOrderRow_control();								
								} 
							});
	});*/
	...
	{		
		...
		$(parent).find('tr').each(function(i){
			var itemId = $(this).attr('data-id-control');
			if(ctr == itemId){
   ...
   $('#ligne_form_control .select2').each(function(){
		var $sel=$(this).parent();
		$(this).select2({
			dropdownParent:$sel
		});	 
		  ...
		  ClearForm();
		   ShowLoader("Chargement détails liés au compteur en cours..."); 
                                            ...
                                            url:"controller.php",
                                                    dataType:"json",
                                                    method:"GET",
                                                    data: {view:'prepare_controle', k:jeton_actuel},
	...
	?>
						...
						jQuery(document).delegate('a.view-fiche', 'click', function(e) {
							 e.preventDefault();
                                    ...
                                    url:"controller.php",
                                            method:"GET",
                                            data:{view:view_mode, q:jeton_actuel}, 
											beforeSend: function() {
					...
					swal({
										...
										if (isConfirm) {          
											  ...
											  $.ajax({
												   url:"controller.php",
												   method:"POST",
												   data:{view:view_mode,k:jeton_actuel},
												   success:function(data)
												   {
													  var result = $.parseJSON(data);
																 if(result.error == 0) {
	...
	?>
                ...
                $("#id_equipe").on("change", function(e) {
                    ...
                    $.ajax({
                        url: "controller.php",
                        method: "GET",
                        data: {view: "get_organisme_chief", id_: item},
                        success: function(data, statut) { 
                            try {
                                var result = $.parseJSON(data);
                                if (result.error == 0) {
	...
	//$('.edit-control').click(function () {				  
				...
				$('#titre_control').html('MODIFICATION INFORMATIONS CONTROLE');
				  $.ajax({
					   ...
					   dataType:"json",
					   method:"GET",
					   data: {view:'detail_control',k:jeton_actuel},
							 ...
							 if(result.error == 0) {
								  ...
								  $('#doc_save_mode').html('');
												if(result.data.is_draft_control == '1'){
													...
													$('#doc_save_mode').append('<option value="1">Brouillon</option>');
													$('#doc_save_mode').append('<option value="0">Définitive</option>');
												}else{$('#doc_save_mode').append('<option value="0">Définitive</option>');
								 ...
								 $("#view_control").val("edit_control");
								  ...
								  if(result.data.gps_longitude!=null && result.data.gps_latitude != null){
														...
														//$("#btn_map_viewer").text('Visualiser Carte');
														$("#btn_map_viewer").removeAttr('disabled');														$("#btn_map_viewer").show();
														//$("#btn_map_viewer").removeClass('btn-outline-danger');
														//$("#btn_map_viewer").addClass('btn-outline-light');
 ...
 <!--  <script type="text/javascript" src="assets/js/webcam.min.js"></script>  -->
  ...
  var current_position, current_accuracy;
		...
		function locateNew() {
				...
				{
					navigator.geolocation.getCurrentPosition(showPosition,showError, {maximumAge: 0,enableHighAccuracy:true} );
				}
				else
				{
