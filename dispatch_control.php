...
$rendez_vous = '<span class="badge badge-primary client-rendez-vous">' . $row['data']['date_rendez_vous_fr'] . '</span>';
								 ...
								 <div class="client-row card bg-white"> 
								  <div class="card-header d-flex">
                                       <div>	<div class="text-dark">Client </div>  <h4 class="mb-0 text-primary client-name"><?php echo $row['data']['nom_client_blue'] . ' ' . $rendez_vous ; ?></h4></div>	
                                        </div>
									<div class="card-body">	
							...
							<?php } ?>
							<div class="row">	<div class="col-sm-3"><div class="text-dark">Adresse</div>	<div class="font-medium text-primary client-adress"><?php echo  $row['adresseTexte']; ?></div></div><div class="col-sm-3"><div class="text-dark">REFERENCE APPARTEMENT</div>	<div class="font-medium text-primary client-adress"><?php echo  $row['data']['reference_appartement']; ?></div></div><div class="col-sm-3 text-center">	<div class="text-dark">Téléphone</div>	<div class="font-medium text-primary client-phone"><?php echo $row['data']['phone_client_blue']; ?></div></div><div class="col-sm-3 text-right">	<div class="text-dark">CVS	</div>	<div class="font-medium text-primary client-cvs"><?php echo  $row['data']['libelle']; ?></div></div></div>	<div class="row"><div class="col-sm-3">	<div class="text-dark">Compteur	</div>	<div class="font-medium text-primary client-device"><?php echo  $row['data']['num_compteur_actuel']; ?> </div></div> 
									
									
									<div class="col-sm-3  text-center">	<div class="text-dark">Technicien	</div>	<div class="font-medium text-primary client-technician"><?php echo  $row['technicien']; ?></div></div>
									
									<div class="col-sm-3 text-right">	<div class="text-dark">Chef équipe	</div>	<div class="font-medium text-primary client-chief"><?php echo  $row['chef']; ?></div></div>
