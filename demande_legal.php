<?php
// session_start();
$mnu_title = "DEMANDE DE RE-LEGALISATION";
$page_title = "Historique des demandes de ré-légalisation";
$home_page = "demande_legal.php";
$active = "demande_legal";
$parambase = ""; 
...
$Abonne->type_notification ='3';//DEMANDE DE RE-LEGALISATION
...
<html lang="en">
    ...
    <body>
        ...
        <div class="dashboard-main-wrapper">
                            ...
                            <div class="page-header">
                              <!--  <h2 class="pageheader-title"><?php echo $mnu_title; ?></h2>  -->
                                <div id="breadcrumbs" class="clearfix">
                                    <a href="<?php echo $home_page . '.php'; ?>" class="breadcrumbs_home"><i class='fas fa-calendar-check nav_icon'></i>  <?php echo $mnu_title; ?></a> <span class="raquo">»</span></div>
                            </div>
                        </div>
                    </div>
			...
			<div class="card-header d-flex"> 
											<div>	<div class="text-dark">Compteur</div>  <h4 class="mb-0 text-primary"><?php echo $row_["num_compteur"];   ?></h4></div>
   ...
   jQuery(document).delegate('a.uncheckAll', 'click',function(){
				...
				$("#ctr-select-all").text("Sélectionner tout");   
                                ...
                                url:"controller.php",
                                        method:"GET",
                                        data: {view:"get_cvs_compteur", id_:item},
