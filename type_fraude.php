<?php 
 ...
 // session_start();
 $mnu_title = "Type Fraude";
 $page_title = "Liste des Types Fraudes";
 $home_page = "index.php";
 $active = "type_fraude";
 $parambase = " active";
   ...
   <form id="dlg_frm" method="post" action="controller.php" enctype="multipart/form-data">  
		...
		<div class="form-group">
                 ...
                 <div class="input-group"  style="width: 100%;" > 
                   <input type="text" class="form-control pull-right" name="code_label" id="code_label">
                 </div> 
         </div>
		<div class="form-group">
                 <label>Libellé Type Fraude</label>
                 <div class="input-group"  style="width: 100%;" > 
...
jQuery(document).delegate('a.delete-item', 'click', function(e) {
		...
		var label=$('tr.item-row[data-id="' + itemId + '"]').find('span.sn').html();     
 					...
 					swal({
 										...
 										if (isConfirm) {     
 											   var view_mode ="delete_type_fraude";
 											  $.ajax({
 												   url:"controller.php",
 												   method:"POST",
 					   dataType:"json",
 ...
 <?php //if($utilisateur->HasDroits("12_38")){  ?>	 $("#add_line").click(function () {	
					...
					ClearR();
					 $("#dlg_frm #view").val("create_type_fraude");
 ...
 jQuery(document).delegate('a.edit-item', 'click', function(e) {
		...
		$("#dlg_main #view").val("edit_type_fraude");
