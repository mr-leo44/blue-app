...
// session_start();
$mnu_title = "";
$page_title = "Rapport compteurs en état de fraude";
$active = "rpt_compteur_fraude";
$parambase = "";
                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							...
							<h2>Rapport des compteurs en état de fraude</h2>
                        ...
                        <!-- ============================================================== -->
							<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
								...
								<div class="card">
									...
									<div class="card-body">
									<form method="post" action="reporting/rpt_compteur_en_etat_de_fraude_xls.php" target="blank">
											<div class="row">
