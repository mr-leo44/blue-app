...
// session_start();
$mnu_title = "Statut_connexion_client";
$page_title = "Liste des Statut_connexion_clients";
$home_page = "index.php";
$active = "statut_connexion_client";
$parambase = " active";
...
/*
 ...
 include_once "classes/class.statut_connexion_client.php";*/
$database = new Database();
$db = $database->getConnection();
$item = new Statut_connexion_client($db);
...
$stmt = null;
$page_url = "statut_connexion_client.php?";
		...
		$(function() {
			...
			<?php if ($utilisateur->HasDroits("12_40")) {  ?> $(".delete").click(function() {
					...
					swal({
						...
						if (isConfirm) {
							var view_mode = "delete_statut_connexion_client";
							$.ajax({
								url: "controller.php",
								method: "POST",
								data: {
			...
			<?php if ($utilisateur->HasDroits("12_38")) {  ?> $("#btn_new_").click(function() {
					ClearForm();
					$("#view").val("create_statut_connexion_client");
					$("#Heading").html("CREATION STATUT_CONNEXION_CLIENT");
					$("#dlg_main").modal("show");
				});
			<?php } ?>
			...
			<?php if ($utilisateur->HasDroits("12_39")) {  ?>
				$(".edit").click(function() {
					ClearForm();
					var jeton_actuel = jQuery(this).attr("data-id");
					$("#Heading").html("MODIFICATION INFORMATIONS STATUT_CONNEXION_CLIENT");
					$.ajax({
						url: "controller.php",
						method: "GET",
						dataType: "json",
						data: {
							view: "detail_statut_connexion_client",
							code: jeton_actuel
						},
						success: function(result, statut) {
							$("#view").val("edit_statut_connexion_client");
