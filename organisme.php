                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                         ...
                         <!--  <h2 class="pageheader-title"><?php echo $mnu_title; ?></h2>  -->
                                    <div id="breadcrumbs" class="clearfix">
                                        <a href="<?php echo 'organisme.php'; ?>" class="breadcrumbs_home"><i class='fas fa-folder-open nav_icon'></i>  <?php echo $mnu_title; ?></a> <span class="raquo">»</span></div>
                                </div>
                            </div>
                        </div>
                    </div> 
                    ...
                    swal({
                        ...
                        if (isConfirm) {
                            ...
                            $.ajax({
                                url: "controller.php",
                                method: "POST",
                                data: {view: view_mode, ref_organisme: jeton_actuel},
...
<?php //if($utilisateur->HasDroits("12_39")){   ?>
                $(".edit").click(function() {
                    ...
                    $.ajax({
                        ...
                        method: "GET",
                        dataType: "json",
                        data: {view: "detail_organisme", ref_organisme: jeton_actuel},
                        success: function(result, statut) {
...
<?php //}   ?>
                ...
                $("#code_province").on("change", function(e){
                    ...
                    $.ajax({
                        url: "controller.php",
                        method: "GET",
                        data: {view: "get_province_ville", id_: item},
