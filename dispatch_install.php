<?php 
 // session_start();
 $mnu_title = "Dispatching Installation";
 $page_title = "Journal Dispatching installation";
 $home_page = "index.php";
 $active = "dispatch_install";
 $parambase = "";
 $create_view = 'dispatch_install_set_user';
$edit_view = '';
$delete_view = '';
...
Autoloader::Load('classes');
 ...
 $accessibility = new Param_Accessibility($db);
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
								...
								<div class="card-header d-flex">
                                       <div><h4 class="mb-0 text-primary"><?php echo $page_title; ?></h4></div> 
									     <?php 
												 if ($utilisateur->HasDroits("10_625")) { ?> 
...
<?php  echo count($_items) . ' Elément(s)'; ?></div>
								...
								<form action="dispatch_install.php" method="post"><input type="text" id="srch-term-client" name="srch-term-client" class="form-control" placeholder="Recherche..."  value="<?php echo $search_param; ?>">
...
$rendez_vous = '<span class="badge badge-primary client-rendez-vous">' . $row['data']['date_rendez_vous_fr'] . '</span>';
								...
								if($row['data']['est_installer'] == '1'){   
								 ...
								 <div class="client-row card bg-white"> 
								  <div class="card-header d-flex">
                                       <div>	<div class="text-dark">Client </div>  <h4 class="mb-0 text-primary client-name"><?php echo $row['data']['nom_client_blue'] . ' ' . $rendez_vous ; ?></h4>
									   
									   <?php 
									   $texte_ = '';
							if(!empty($row['data']['accesibility'])){
 $accessibility->code= $row['data']['accesibility'];								
 $accessibility->GetDetailIN();		
$bagde =  Utils::getInstallType_Badge($accessibility->code);
									$texte_ = '<span class="badge ' . $bagde. '">' . $accessibility->libelle . '</span>';
								}
							...
							if ($utilisateur->HasDroits("10_910")|| $has_technician == 0) {   ?>
							...
							<?php } ?>
									<div class="row">	<div class="col-sm-3"><div class="text-dark">Adresse</div>	<div class="font-medium text-primary client-adress"><?php echo  $row['adresseTexte']; ?></div></div><div class="col-sm-3"><div class="text-dark">REFERENCE APPARTEMENT</div>	<div class="font-medium text-primary client-adress"><?php echo  $row['data']['reference_appartement']; ?></div></div><div class="col-sm-3 text-center">	<div class="text-dark">Téléphone</div>	<div class="font-medium text-primary client-phone"><?php echo $row['data']['phone_client_blue']; ?></div></div><div class="col-sm-3 text-right">	<div class="text-dark">CVS	</div>	<div class="font-medium text-primary client-cvs"><?php echo  $row['data']['libelle']; ?></div></div></div>	<div class="row"><div class="col-sm-3">	<div class="text-dark">Compteur	</div>	<div class="font-medium text-primary client-device"><?php echo  $row['data']['num_compteur_actuel']; ?> <span class="badge badge-info client-mode-install"><?php echo  $operation; ?></span></div></div> 
									
									
									<div class="col-sm-4  text-center">	<div class="text-dark">Technicien	</div>	<div class="font-medium text-primary client-technician"><?php echo  $row['technicien']; ?></div></div>
							
									<div class="col-sm-4 text-right">	<div class="text-dark">Chef équipe	</div>	<div class="font-medium text-primary client-chief"><?php echo  $row['chef']; ?></div></div>
									
										<?php if(isset($row['data']['date_assign_technicien'])){ ?>	
									<div class="col-sm-4">	<div class="text-dark">Date  assignation	</div>	<div class="font-medium text-primary client-chief"><?php echo  $row['data']['date_assign_technicien']; ?></div></div>
										<?php } ?>
   ...
   <div class="modal" id="loadMe" tabindex="-1" role="dialog" aria-hidden="true" >
            ...
            <div class="modal fade" id="box_technicien" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog  modal-sm" role="document">
                    <div class="modal-content"> 
...
<?php	if($utilisateur->HasDroits("10_625")) { ?>
