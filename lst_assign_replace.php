                            ...
                            <div class="page-header">
                              <!--  <h2 class="pageheader-title"><?php echo $mnu_title; ?></h2>  -->
                                <div id="breadcrumbs" class="clearfix">
                                    <a href="<?php echo 'lst_assign_replace.php'; ?>" class="breadcrumbs_home"><i class='fas fa-calendar-plus nav_icon'></i>  <?php echo $mnu_title; ?></a> <span class="raquo">»</span></div>
                            </div>
                        </div>
                    </div>
...
$nom_identificateur = $utilisateur->GetUserDetailName($row_['identificateur']);
 ...
 <option selected='selected' disabled>Veuillez préciser</option>
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">						
                            ...
                            <div class="card">
                               <div class="card-header d-flex">
							   <div>	<div class="text-dark">Liste des compteurs</div>  <h4 class="mb-0 text-primary" id="nbre_resultat_box"><span ></span></h4></div> 
   ...
   jQuery(document).delegate('a.uncheckAll', 'click',function(e){
	    e.preventDefault();
				...
				$("#ctr-select-all").text("Sélectionner tout");   
                                ...
                                url:"controller.php",
                                        method:"GET",
                                        data: {view:"get_cvs_compteur_replace", id_:item, search_param:search_param},
