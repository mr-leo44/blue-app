                            ...
                            <div class="page-header">
                              <!--  <h2 class="pageheader-title"><?php echo $mnu_title; ?></h2>  -->
                                <div id="breadcrumbs" class="clearfix">
                                    <a href="<?php echo 'users.php'; ?>" class="breadcrumbs_home"><i class='fas fa-user nav_icon'></i>  <?php echo $mnu_title; ?></a> <span class="raquo">»</span></div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal fade" id="dlg_site" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form <?php //if($utilisateur->HasDroits("12_56")){  ?> action="controller.php" method="post" id="frm_law" <?php //}  ?>>
<?php //if($utilisateur->HasDroits("12_56")){  ?><input type="hidden" name="view" id="view"  value="grant_site"/><?php //}  ?>
...
<?php if ($utilisateur->HasDroits("10_190")) {
    ?>	 $('#btn_new_').click(function () {
            ...
            url:"controller.php",
                    method:"POST",
                    data: {view:view_mode, z_:z_, k:k, nk:nk, gp:gp, etat:etat, site:site, is_chief:is_chief,access_au_module_deux:access_au_module_deux, email_user:email_user, phone_user:phone_user, id_organisme:id_organisme, id_organisme_chief:id_organisme_chief, chef_equipe_id:chef_equipe_id},
...
<?php if ($utilisateur->HasDroits("10_180")) {
    ?>
                ...
                url:"controller.php",
                        method:"GET",
                        data: {view:'detail_user', k:jeton_actuel},
