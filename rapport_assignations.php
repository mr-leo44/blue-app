...
// session_start();
$mnu_title = "";
$page_title = "Rapport Assignations";
$active = "rpt_assignations";
$parambase = "";
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                ...
                                <h2>Rapport des assignations</h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form method="post" action="reporting/rpt_assignations_xls.php" target="blank">
                                                <div class="row">
