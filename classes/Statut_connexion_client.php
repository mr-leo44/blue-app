...
class Statut_connexion_client
{
  ...
  public $date_synchro;
  public $is_sync;
  private $table_name = 't_param_statut_connexion_client';
  private $connection;

  function Create()
  {
    $query = "INSERT INTO " . $this->table_name . "  SET code=:code,libelle=:libelle,n_user_create=:n_user_create,annule=:annule,n_user_annule=:n_user_annule,motif_annulation=:motif_annulation,date_synchro=:date_synchro,is_sync=:is_sync";
  ...
  function Modifier()
  {
    $query = "UPDATE " . $this->table_name . "  SET libelle=:libelle,n_user_update=:n_user_update,date_update=:date_update,annule=:annule,n_user_annule=:n_user_annule,motif_annulation=:motif_annulation,date_synchro=:date_synchro,is_sync=:is_sync WHERE code=:code";
    $stmt = $this->connection->prepare($query);
    $this->code = strip_tags($this->code);
    $this->libelle = strip_tags($this->libelle);
