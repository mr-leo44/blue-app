...
$stmt = null;
$page_url = "province.php?";
$category_id = '3'; //Province
						...
						<div class="card">
							<div class="card-body">
								...
								<table class="table table-bordered table-hover">
									...
									<tbody>
										<?php
										if ($utilisateur->HasDroits("10_516")) {
											$num_line = 0;
	...
	<script>
		$(function() {
			...
			$("#btn_new_").click(function() {
				ClearForm();
				$("#dlg_main #view").val("create_province");
				$("#dlg_main #Heading").html("CREATION PROVINCE");
				$("#dlg_main").modal("show");
			});
			<?php //} 
			?>
			...
			$(".edit").click(function() {
				ClearForm();
				var jeton_actuel = jQuery(this).attr("data-id");
				$("#dlg_main #Heading").html("MODIFICATION INFORMATIONS PROVINCE");
				$.ajax({
					url: "controller.php",
					method: "GET",
					dataType: "json",
					data: {
						view: "detail_province",
						code: jeton_actuel
					},
					success: function(result, statut) {
						$("#dlg_main #view").val("edit_province");
