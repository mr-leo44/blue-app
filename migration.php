<?php
// session_start(); 
$mnu_title = "Migration des données";
$page_title = "Migration des données";
$active = "migration";
$parambase = "";
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="page-header flex-wrap">
                                    <h4 class="mb-0">Migrer les données dasn l'application
    ...
    <script>
        jQuery(document).ready(function($) {
            ...
            $('#btn_import_rep_inpp').click(function() {
                ...
                formData.append("view", "migrate_data");
                ShowLoaderX("Importation des données en cours...");
                $.ajax({
                    url: "<?= $fichier_base ?>",
                    ...
                    error: function(err) {
                        // console.error(err);
                        // JSON.parse(err)
                        swal(err.responseJSON.message, "Module en construction", "warning");
                    },
