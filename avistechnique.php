...
$from_record_num = ($records_per_page * $page) - $records_per_page;
 ...
 <div class="row">
 		...
 		<a href="<?php echo $home_page;?>" class="breadcrumbs_home"><i class="fab fa-fw fa-wpforms nav_icon"></i>  <?php echo $mnu_title; ?></a> <span class="raquo">»</span></div>
                        </div>
                    </div>
                </div>
 	   <div class="row"> 
 	...
 	$(".edit").click(function () {	
 				...
 				$("#Heading").html("MODIFICATION INFORMATIONS AVISTECHNIQUE");
 				  $.ajax({
 					   ...
 					   method:"GET",
 					   dataType:"json",
 					   data: {view:"detail_avistechnique",code:jeton_actuel},
 					   success : function(result, statut){  
